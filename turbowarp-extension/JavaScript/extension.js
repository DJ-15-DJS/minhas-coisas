    ...
    class djdavi15js {
      getInfo() {
        return {
          ...
          metadata: {
            author: 'DJ_Davi15 <https://scratch.mit.edu/users/DJ_Davi15/> & ChatGPT <https://chatgpt.com/>',
            license: 'MIT',
      ...
      executarJS(args) {
        try {
          new Function(args.JScodeexecute)();
        } catch (e) {
      ...
      executarJSBoolean(args) {
        try {
          return new Function('return ' + args.JScodeboolean)();
        } catch (e) {
      ...
      executarJSResultado(args) {
        try {
          return new Function('return ' + args.jsresult)();
        } catch (e) {
